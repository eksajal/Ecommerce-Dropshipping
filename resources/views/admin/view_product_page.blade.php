  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="{{ url('redirect') }}"><img src="admin/images/logo.svg" class="me-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('redirect') }}"><img src="admin/images/logo-mini.svg" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="{{ url('add_product_page') }}" aria-expanded="false" aria-controls="ui-basic">
              <i class="ti-palette menu-icon"></i>
        ...
        <div class="content-wrapper" style="background: #a7c5e0;">
          <div class="row">
            ...
            <tr>
                ...
                <td>
                    <img style="width: 200px; height: 150px;" src="productImage/{{ $data->image }}" alt="">
                </td>
                <td><a class="btn btn-info" href="{{ url('edit_product_page', $data->id) }}">Update</a></td>
                <td><a class="btn btn-danger" href="{{ url('delete_product', $data->id) }}">Delete</a></td>
            </tr>
