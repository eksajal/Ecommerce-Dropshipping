                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        @foreach ($carts as $cart)
                            @php
                                $itemTotal = $cart->price * 1; // Assuming default quantity 1
                                $subtotal += $itemTotal;
                            @endphp

                            <tr>
                                <td class="align-middle"><img src="productImage/{{ $cart->product_img }}"
                                        alt="" style="width: 50px; height: 50px;"> {{ $cart->product_name }}
                                </td>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <a href="{{ url('reseller_checkout_page') }}" class="btn btn-block btn-primary my-3 py-3">Proceed To
                            Checkout</a>
                    </div>
                </div>
            </div>
