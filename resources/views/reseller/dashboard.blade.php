...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="{{ url('reseller_order_history') }}" class="btn border">
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="{{ url('reseller_cart_page') }}" class="dropdown-item">Shopping Cart</a>
                                    <a href="{{ url('reseller_checkout_page') }}" class="dropdown-item">Checkout</a>
                                </div>
                            </div>
                            <a href="{{ url('contact') }}" class="nav-item nav-link">Contact</a>
                            <a href="{{ url('reseller_order_history') }}" class="nav-item nav-link">Order History</a>
                        </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Reseller Dashboard</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <!-- Price Filtering for All Categories -->
                <div class="border-bottom mb-4 pb-4">
                    <h5 class="font-weight-semi-bold mb-4">Filter by price</h5>
                    <form method="GET" action="{{ route('reseller_shop.filter') }}">
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="price-all" name="price_range"
                                value="all" checked>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" style="width: 300px; height: 400px;" src="productImage/{{ $product->image }}" alt="">

                        <!-- Download Image Button on Hover -->
                        <a href="productImage/{{ $product->image }}" download="{{ $product->title }}.jpg" class="btn btn-secondary px-3 download-btn">
                            <i class="fa fa-download mr-1"></i> Download Image
                        </a>
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="{{ url('reseller_product_details', $product->id) }}" class="btn btn-sm text-dark p-0">
                            <i class="fas fa-eye text-primary mr-1"></i>View Detail
                        </a>
                        <a href="{{ url('modify_product_page', $product->id) }}" class="btn btn-sm text-dark p-0">
                            <i class="fas fa-shopping-cart text-primary mr-1"></i>Modify Product
                        </a>
                    </div>
                </div>
            </div>
...
<style>
    ...
    .product-item:hover .download-btn {
        opacity: 1;
        display: block;
    }
</style>
