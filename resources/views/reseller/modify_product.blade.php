...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ url('reseller_dashboard') }}" class="nav-item nav-link">Shop</a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Modify Product</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Home</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Modify Product</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    <div class="card-header bg-secondary border-0">
                        <h4 class="font-weight-semi-bold m-0">Modify Product Details</h4>
                    </div>

                    <!-- Form starts -->
                    <form action="{{ url('reseller_checkout') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">

                            <div class="col-md-6 form-group">
                                <label>Name</label>
                                <input class="form-control" type="text" value="{{ $product->title }}" name="product_name">
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" value="${{ $product->delivery_charge }}" name="delivery_charge">
                            </div>

                            <div class="col-md-6 form-group">
                                <label>Current Image</label>
                                <img width="250px;" height="300px;" src="productImage/{{ $product->image }}" alt="">
                            </div>

                            <div class="col-md-6 form-group">
                                <label>Bkash Number</label>
                                <input class="form-control" type="text" placeholder="Enter your Bkash Number" name="bkash">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment_method"
                                    id="cod" value="Nagad">
                                <label class="custom-control-label" for="cod">Nagad</label>
                            </div>
                        </div>
