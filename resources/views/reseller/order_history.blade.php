                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ url('reseller_order_history') }}" class="nav-item nav-link active">Order
                                History</a>
                        </div>
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="text-center">{{ $order->created_at }}</div>
                                </td>
                                ...
                                <td class="align-middle">
                                    <div class="text-center">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            <img style="width: 50px; height: 50px; margin-right: 10px; margin-left: 0;"
                                                src="productImage/{{ $order->product_image }}" alt="">
                                            <span
                                                style="width: 150px; text-align: left;">{{ $order->product_name }}</span>
                                        </div>
                                ...
                                <td class="align-middle">
                                    ...
                                    <div style="padding: 20px;">{{ $order->modified_price }}</div>

                                </td>

                                <td class="align-middle">

                                    <div style="padding: 20px;">{{ $order->modified_dcharge }}</div>
                                ...
                                <td class="align-middle">
                                    <div class="text-center">
                                        ...
                                        <div style="padding: 20px;">{{ $order->quantity }}</div>
                                ...
                                <td class="align-middle">
                                    <div class="text-center">
                                        @if ($order->approval_status == 'Approved')
                                            <span style="color: green;">{{ $order->approval_status }}</span>
                                        @elseif ($order->approval_status == 'Rejected')
                                            <span style="color: red;">{{ $order->approval_status }}</span>
                                        @else
                                            <span style="color: blue;">{{ $order->approval_status }}</span>
                                        @endif
                                    </div>
                                </td>
                            </tr>
