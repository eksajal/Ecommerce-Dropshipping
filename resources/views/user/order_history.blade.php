                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="text-center">
                                        @if (is_array($order->product_img) && is_array($order->product_name))
                                            @foreach ($order->product_img as $index => $img)
                                                <div class="d-flex align-items-center justify-content-center mb-2">
                                                    <img style="width: 50px; height: 50px; margin-right: 10px; margin-left: 0;"
                                                        src="productImage/{{ $img }}" alt="">
                                                    <span
                                                        style="width: 150px; text-align: left;">{{ $order->product_name[$index] }}</span>
                                                </div>
                                            @endforeach
                                        @else
                                    ...
                                    <div class="text-center">
                                        @if (is_array($order->quantity))
                                            @foreach ($order->quantity as $quantity)
                                                <div style="padding: 20px;">{{ $quantity }}</div>
                                            @endforeach
                                        @else
                                ...
                                <td class="align-middle">
                                    <div class="text-center">
                                        ...
                                        @else
                                            <span style="color: blue;">{{ $order->delivery_status }}</span>
                                        @endif
                                    </div>
                                </td>
                            </tr>
